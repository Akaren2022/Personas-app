    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('paises.update', ['pais' => $pais->pais_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <div id="codigoHelp" class="form-text">Id Pais</div>
            </div>

            <div class="mb-3">
                <label for="name" class="form-label">Pais</label>
                <input type="text" required class="form-control" id="name" name="name" placeholder="Nombre del Pais" value="{{ $pais->pais_nomb }}">
            </div>
