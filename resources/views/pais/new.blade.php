    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('paises.store') }}">
            ...
            <div class="mb-3">
                ...
                <div id="idHelp" class="form-text">Codigo del Pais</div>
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Pais</label>
                <input type="text" class="form-control" id="name" aria-describedby="nameHelp" name="name" placeholder="Nombre del Pais.">
            </div>
