    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('departamentos.update', ['departamento' => $departamento->depa_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <div id="codigoHelp" class="form-text">Id de Departamento</div>
            </div>

            <div class="mb-3">
                <label for="name" class="form-label">Departamento</label>
                <input type="text" required class="form-control" id="name" name="name" placeholder="Nombre de Departamento" value="{{ $departamento->depa_nomb }}">
            </div>
