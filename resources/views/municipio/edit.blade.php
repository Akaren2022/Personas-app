    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('municipios.update', ['municipio' => $municipio->muni_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <div id="codigoHelp" class="form-text">Id de Municipio</div>
            </div>

            <div class="mb-3">
                <label for="name" class="form-label">Municipio</label>
                <input type="text" required class="form-control" id="name" name="name" placeholder="Nombre de municipio" value="{{ $municipio->muni_nomb }}">
            </div>
